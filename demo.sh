...
CREATE_MESSAGE='{"type":"CreateMeet","payload":{"meet_id":"demo-meet-123","password":"TestPassword123!"}}'
...
JOIN_MESSAGE="{\"type\":\"JoinMeet\",\"payload\":{\"meet_id\":\"$MEET_ID\",\"password\":\"TestPassword123!\"}}"
